      ...
      <Box marginTop="50px">
        <Flex>
          <Box flex="1" p="4" marginTop="50px">
            ...
            <Text fontSize="1xl">
              ...
              thái của từng nhiệm vụ, giúp bạn theo dõi và kiểm soát quy trình
        ...
        >
          ...
          <Card>
            ...
            <CardBody>
              <Text>
                Reduce bottlenecks by setting the maximum amount of work that
                can exist in each status with work in progress limits.
              </Text>
            </CardBody>
          </Card>
          <Card>
            ...
            <CardBody>
              <Text>
                ...
                back to your business, with agile reports like the cumulative
                flow diagram.
              </Text>
            </CardBody>
          </Card>
